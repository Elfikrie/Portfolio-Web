    ...
    <div className="min-h-screen pt-12 pb-24 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 w-full">
      <div className="mb-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-3xl font-extrabold text-white">Manage <span className="text-salmon-500">Notes</span></h1>
            <p className="text-gray-400 mt-1">Admin dashboard to manage diary entries and thoughts.</p>
          </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm text-gray-400">
            ...
            <tbody className="divide-y divide-zinc-800">
              {rows.map((note: any) => {
                const boundDelete = deleteNote.bind(null, note.id.toString());
                return (
                  <tr key={note.id} className="hover:bg-zinc-800/20 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex justify-end gap-3 items-center">
                        ...
                        <DeleteButton deleteAction={boundDelete} itemName="Note" />
                      </div>
                    </td>
                  </tr>
                );
